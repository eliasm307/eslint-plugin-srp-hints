...
const { ['function-description']: defaultOptions } = require('../../defaultOptions');
...
module.exports = {
	...
	create: function (context) {
		...
		let { minLines, descriptionPrefix, minDescriptionContentLength } = defaultOptions;

		console.log(__filename, 'BEFORE manual assignment', {
			defaultOptions,
			minLines,
			descriptionPrefix,
		...
		/* ! OLD
		let minLines = defaultOptions.minLines || 30;
		let descriptionPrefix = defaultOptions.descriptionPrefix || "This function's responsibility is";
		let minDescriptionContentLength = defaultOptions.minDescriptionContentLength || 10;
		*/
		...
		console.log(__filename, 'AFTER manual assignment', {
			defaultOptions,
			minLines,
			descriptionPrefix,
			minDescriptionContentLength,
